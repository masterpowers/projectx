...
<h5 class="page__title">Create New Products</h5>

{!! Form::open(['route' => 'admin::product@store', 'method' => 'POST', 'class' => 'col s12 form', 'files' => true]) !!} 
...
<input class="file-path validate" type="text" placeholder="Upload Product Picture">
</div>
...
<div class="row">
{!! Form::submit('Add New Product', ['class' => 'btn offset-s1 col s10']) !!}
</div>
